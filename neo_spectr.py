...
# ===============================================================
# Поріг шуму по смугам (в "dB над шумовим порогом")
# лог-подібний розподіл до ~18 кГц
...
_scale_db = 20.0       # стартове значення (чим менше, тим агресивніше піднімає тихі сигнали)
...
num_dbfs = 0
dbfs_all = [0] * 16
def build_band_spectr_old(spec, out_buf):
    # початкова перевірочна версія функції
